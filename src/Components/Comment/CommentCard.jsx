    ...
    return (
        <div>
            <div className='flex items-center justify-between py-5'>
                ...
                {isCommentLike ? <AiFillHeart
                    onClick={handleUnlikeComment} className='text-xs hover:opacity-60 cursor-pointer text-red-700' /> :
                    <AiOutlineHeart onClick={handleLikeComment} className='text-xs hover:opacity-60 cursor-pointer' />}
